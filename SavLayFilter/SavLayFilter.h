...
class SavLayFilter {
  ...
  public:
    SavLayFilter();
    float quadCubicSmooth(int8_t windowSize, float inputValue);
    float quadCubicSmoothCalc(int8_t windowSize, float *windowArray[]);
  private:
    ...
    int32_t _quadCubicSmoothConvolute[11][13] = {
      ...
      { -42, -21, -2, 15, 30, 43, 54, 63, 70, 75, 78, 79, 0},
      { -254, -138, -33, 62, 147, 222, 287, 322, 387, 422, 447, 462, 467}
    };

    int32_t _quadCubicSmoothNormalFactor[11][1] = {
      {35},
      {21},
      {231},
      {429},
